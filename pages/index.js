      ...
      <div style={{
        ...
        <div style={{ maxWidth: '600px', textAlign: 'center' }}>
          <div style={{
            ...
            <CheckCircle size={64} style={{ color: '#4ade80', margin: '0 auto 24px' }} />
            <h2 style={{ fontSize: '28px', fontWeight: 'bold', margin: '0 0 12px 0' }}>Ready to Go</h2>
            <p style={{ color: '#cbd5e1', margin: 0 }}>Loading your diagnostic...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto', paddingTop: '40px' }}>
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: '8px', color: '#cbd5e1' }}>Days to close</label>
                <input
                  type="number"
                  name="closeTimeDays"
                  placeholder="10-12"
            ...
            <div style={{ marginBottom: '24px' }}>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: '8px', color: '#cbd5e1' }}>Team size (FTEs)</label>
              <input
                type="number"
                name="teamSize"
                placeholder="3-8"
            ...
            <div style={{ marginBottom: '24px' }}>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: '12px', color: '#cbd5e1' }}>Your bottlenecks:</label>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {painPointOptions.map(option => (
                  <label key={option.id} style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', padding: '10px', borderRadius: '6px', backgroundColor: formData.painPoints.includes(option.id) ? '#334155' : 'transparent' }}>
                    <input
                      type="checkbox"
                    ...
                    />
                    <span style={{ color: '#cbd5e1', fontSize: '14px' }}>{option.label}</span>
                  </label>
                ))}
              </div>
            </div>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', paddingTop: '40px' }}>
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px 0' }}>Your FI/CO Diagnostic</h2>
              <p style={{ color: '#cbd5e1', margin: 0 }}>{report.companyName}</p>
            </div>
            ...
            <div style={{ padding: '32px', borderBottom: '1px solid #e2e8f0' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  <div>
                    <p style={{ color: '#475569', fontSize: '14px', margin: 0 }}>Working Capital/Month</p>
                    <p style={{ fontSize: '24px', fontWeight: 'bold', color: '#92400e', margin: '8px 0 0 0' }}>${(report.workingCapitalImpact / 1000).toFixed(0)}K</p>
                  </div>
                  <div>
                    <p style={{ color: '#475569', fontSize: '14px', margin: 0 }}>Annual Impact</p>
            ...
            <div style={{ padding: '32px', borderBottom: '1px solid #e2e8f0' }}>
              <h3 style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '24px', color: '#0f172a' }}>Recommendations</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {report.recommendations.map((rec, i) => (
                  <div key={i} style={{ borderLeft: '4px solid #3b82f6', paddingLeft: '20px' }}>
                    <h4 style={{ fontWeight: 'bold', color: '#0f172a', marginBottom: '8px' }}>{i + 1}. {rec.area}</h4>
                    <p style={{ color: '#475569', marginBottom: '8px', fontSize: '14px' }}><span style={{ fontWeight: '600' }}>Issue:</span> {rec.issue}</p>
                    <p style={{ color: '#475569', marginBottom: '8px', fontSize: '14px' }}><span style={{ fontWeight: '600' }}>Solution:</span> {rec.recommendation}</p>
                    <div style={{
            ...
            <div style={{ padding: '32px', background: '#f1f5f9' }}>
              <h3 style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '16px', color: '#0f172a' }}>Next Steps</h3>
              <p style={{ color: '#475569', marginBottom: '12px', fontSize: '14px' }}>
                Schedule a <span style={{ fontWeight: '600' }}>20-minute call</span> to discuss implementation.
              </p>
              <p style={{ color: '#0f172a', fontWeight: '600', fontSize: '14px', margin: 0 }}>
                Investment: $18,000 - $25,000 | Payback: 2-3 months
              </p>
            </div>
          </div>
